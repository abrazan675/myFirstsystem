			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="services">
						...
						<div class="desc">
							<h3>Rooms Form</h3>
							<form action = "SaveCleint.php" method = "POST">
							
			<input type = "text" name = "cname" placeholder = "client name">
			<br>
			<input type = "text" name = "cid" placeholder = "client Nat-ID">
			<br>
			<input type = "text" name = "cage" placeholder = "client age">
			<br>
			<input type = "text" name = "cgender" placeholder = "client gender">
			<br>
