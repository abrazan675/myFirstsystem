				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li><a href="#">display all clients</a></li>
							<li><a href="#">display all rooms</a></li>
						</ul>
					</nav>
				</div>
			</div>
				...
				<div class="col-md-4">
					<div class="services">
						...
						<div class="desc">
							...
							<?php 
							 $sql = " SELECT `tableid`, `age`, `gender`, `name`, `Nat-ID` FROM `clients`  ";
							...
							?>
				<?php 
							 $sql = " SELECT `tableid`, `name`, `type`, `stat` FROM `rooms`   ";
							 $result = $conn->query($sql);
							...
							?>
			<input type = "text" name = "rentprice" placeholder = "room price">
			<br>
			<input type = "date" name = "rentdate" placeholder = "Rent Date">
			<br>
